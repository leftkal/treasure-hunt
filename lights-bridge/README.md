...
- Entries 3, 5, 6, 7, and 9 each schedule one normal ambient sound instead of playing it immediately. Delays are entry 3=20s, entry 5=20s, entry 6=50s, entry 7=40s, entry 9=90s. Entries 2, 4, and 8 skip normal ambient sounds. Entry 3's normal ambient sound starts 3 seconds into the file and is capped at 5 seconds; the others are capped at 7 seconds.
